...
--Argentinos
 ...
 ('Federico','Redondo', CONVERT(DATE, '18/01/2003', 103), 'ARG',(select ID from Equipos where Nombre like '%Argentinos%'),'MED','https://s2.glbimg.com/C1srRsog-Ek9fJ-x9_Pj6aZ4JjY=/0x0:828x1025/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_bc8228b6673f488aa253bbcb03c80ec5/internal_photos/bs/2023/d/D/QSVCNzSByxcAUHKzHzIQ/whatsapp-image-2023-04-18-at-15.45.00.jpeg', 3, 1), 
 ('Fabricio','Dominguez', CONVERT(DATE, '24/06/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Argentinos%'),'MED','https://elintra.com.ar/wp-content/uploads/2023/04/ARGENTINOS-3.png', 3, 1), 
 ('Matias','Vera', CONVERT(DATE, '20/11/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Argentinos%'),'MED','https://elintra.com.ar/wp-content/uploads/2023/04/ARGENTINOS-3.png', 3, 1), 
 ('Franco','Moyano', CONVERT(DATE, '13/09/1997', 103), 'ARG',(select ID from Equipos where Nombre like '%Argentinos%'),'MED','https://www.ceroacero.es/img/jogadores/00/774600_med__20210420142427_franco_moyano.png', 3, 1), 
 ('Gabriel','Avalos', CONVERT(DATE, '12/10/1990', 103), 'ARG',(select ID from Equipos where Nombre like '%Argentinos%'),'DEL','https://assets.sorare.com/image-resize/player/5fa24a37-dd8e-4148-8ec7-0d3b339bbd15/picture/tinified-4ee41d69ae95be32eeafebe3487d0b82.png?width=640', 2, 1), 
 ('Thiago','Nuss', CONVERT(DATE, '02/02/2001', 103), 'ARG',(select ID from Equipos where Nombre like '%Argentinos%'),'DEL','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBniNAA39T2YOFeE0LBj2azvTx5hS8LCjkoQ&usqp=CAU', 3, 1),
 ...
 ('Lucas','Souto', CONVERT(DATE, '11/10/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'DEF','https://lc.cx/8_63V6',3,1), 
 ('Néstor','Breitenbruch', CONVERT(DATE, '13/09/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'DEF','https://lc.cx/a1iObb',2, 1), 
 ('Maximiliano','Centurión', CONVERT(DATE, '20/02/1999', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'DEF','https://s.hs-data.com/bilder/spieler/gross/459461.jpg', 3,1), 
 ('Facundo','Cardozo', CONVERT(DATE, '06/04/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'DEF','https://i.pinimg.com/originals/17/af/be/17afbed3150459def62604be87d366df.jpg', 3,1), 
 ('Adrián','Spörle', CONVERT(DATE, '13/07/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'DEF','https://imagecache.365scores.com/image/upload/f_png,w_80,h_80,c_limit,q_auto:eco,dpr_2,d_Athletes:default.png,r_max,c_thumb,g_face,z_0.65/Athletes/44313', 3,1), 
 ('Felipe','Peña Biafore', CONVERT(DATE, '05/04/2001', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'MED','https://bolavip.com/export/sites/lpm/img/2023/02/06/foj5u8txeacfs0b.jpeg_890743846.jpeg', 3, 1), 
 ('Braian','Rivero', CONVERT(DATE, '22/02/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'MED','https://lc.cx/Zlpp0x', 3, 1), 
 ('Lautaro','Guzmán', CONVERT(DATE, '18/01/2000', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'MED','https://lc.cx/e0151A', 3, 1), 
 ('Flabián','Londoño', CONVERT(DATE, '09/06/2000', 103), 'COL',(select ID from Equipos where Nombre like '%Arsenal%'),'DEL','https://imagecache.365scores.com/image/upload/f_png,w_80,h_80,c_limit,q_auto:eco,dpr_2,d_Athletes:default.png,r_max,c_thumb,g_face,z_0.65/Athletes/104156',3, 1), 
 ('Santiago','Toloza', CONVERT(DATE, '28/10/2002', 103), 'ARG',(select ID from Equipos where Nombre like '%Arsenal%'),'DEL','https://www.ole.com.ar/images/2023/04/26/M2SW10OqZ_720x0__1.jpg', 3,1), 

 --Atl Tucumán

 ('Tomás','Marchiori', CONVERT(DATE, '20/06/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'ARQ','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/94_20230203142913.jpg', 3, 1),
 ('Renzo','Tesuri', CONVERT(DATE, '07/06/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'DEF','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/163_20230203144546.jpg', 3, 1),
 ('Bruno','Bianchi', CONVERT(DATE, '17/02/1989', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'DEF','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/171_20230203143003.jpg', 2, 1),
 ('Nicolás','Romero', CONVERT(DATE, '28/11/2003', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'DEF','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/174_20230203143359.jpg', 3, 1),
 ('Matías','Orihuela', CONVERT(DATE, '17/02/1992', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'DEF','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/190_20230203143549.jpg', 3, 1),
 ('Adrián','Sánchez', CONVERT(DATE, '14/05/1999', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'MED','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/193_20230203144620.jpg', 3, 1),
 ('Guillermo','Acosta', CONVERT(DATE, '31/10/1988', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'MED','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/135_20230203144526.jpg', 2, 1),
 ('Joaquín','Pereyra', CONVERT(DATE, '01/12/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'MED','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/162_20230203144559.jpg', 3, 1),
 ('Marcelo','Estigarribia', CONVERT(DATE, '10/04/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'DEL','https://www.clubatleticotucuman.com.ar//imagenes/jugadores/199_20230203145458.jpg', 3, 1),
 ('Ramiro','Ruiz Rodríguez', CONVERT(DATE, '21/03/2000', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'DEL','	https://www.clubatleticotucuman.com.ar//imagenes/jugadores/133_20230203145333.jpg', 3, 1),
 ('Mateo','Coronel', CONVERT(DATE, '24/10/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Tucum%'),'DEL','	https://www.clubatleticotucuman.com.ar//imagenes/jugadores/133_20230203145333.jpg', 3, 1),

 --BANFIELD

 ('Facundo','Cambeses', CONVERT(DATE, '09/04/1997', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'ARQ','https://clubabanfield.org/wp-content/uploads/2023/03/cambeses-facundo.webp', 3, 1),
 ('Emanuel','Insúa', CONVERT(DATE, '10/04/1991', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'DEF','https://clubabanfield.org/wp-content/uploads/2023/03/insua-emanuel.webp', 2, 1),
 ('Aaron','Quirós', CONVERT(DATE, '31/01/2001', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'DEF','https://clubabanfield.org/wp-content/uploads/2023/03/quiros-aaron.webp', 3, 1),
 ('Alejandro','Maciel', CONVERT(DATE, '22/04/1997', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'DEF','https://clubabanfield.org/wp-content/uploads/2023/03/maciel-alejandro.webp', 3, 1),
 ('Emanuel','Coronel', CONVERT(DATE, '01/02/1997', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'MED','https://clubabanfield.org/wp-content/uploads/2023/03/coronel-emanuel.webp', 3, 1),
 ('Alejandro','Cabrera', CONVERT(DATE, '30/09/1992', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'MED','https://clubabanfield.org/wp-content/uploads/2023/03/cabrera-alejandro.webp', 3, 1),
 ('Brahian','Aleman', CONVERT(DATE, '23/12/1989', 103), 'URY',(select ID from Equipos where Nombre like '%Banfield%'),'MED','https://clubabanfield.org/wp-content/uploads/2023/03/aleman-brahian-1.webp', 2,1),
 ('Juan','Bisanz', CONVERT(DATE, '28/08/2001', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'MED','https://clubabanfield.org/wp-content/uploads/2023/03/bisanz-juan.webp', 3, 1),
 ('Matías','Romero', CONVERT(DATE, '01/02/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'MED','https://clubabanfield.org/wp-content/uploads/2023/03/romero-matias.webp', 3, 1),
 ('Nicolás','Sosa', CONVERT(DATE, '06/04/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'MED','https://clubabanfield.org/wp-content/uploads/2023/03/sosa-sanchez-nicolas.webp', 3, 1),
 ('Milton','Giménez', CONVERT(DATE, '12/08/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Banfield%'),'MED','https://clubabanfield.org/wp-content/uploads/2023/03/milton.webp', 3, 1),

 --Barracas Central

('Andrés','Desabato', CONVERT(DATE, '21/04/1983', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'ARQ','https://www.barracascentral.com/images/2020/2021/plantel2023/1-_Desbato_Andrs-BRAZOS-ATRAS.jpg', 3,1), 
('Mauro','Peinipil', CONVERT(DATE, '03/04/1999', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'DEF','https://www.barracascentral.com/images/2020/2021/plantel2023/4-_Peinipil_Mauro-BRAZO-ATRAS.jpg', 3,1), 
('Francisco','Álvarez', CONVERT(DATE, '26/02/2000', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'DEF','https://www.barracascentral.com/images/2020/2021/plantel2022/2-FOSSA.jpg', 3,1), 
('Juan','Díaz', CONVERT(DATE, '26/05/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'DEF','https://www.barracascentral.com/images/2020/2021/plantel2022/14-DIAZ.jpg', 3,1), 
('Rodrigo','Insúa', CONVERT(DATE, '16/12/1997', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'DEF','https://www.barracascentral.com/images/2020/2021/plantel2023/6-_Insa_Rodrigo-BRAZOS-ATRAS.jpg', 3,1), 
('Carlos ','Arce', CONVERT(DATE, '16/09/1990', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'MED','https://www.barracascentral.com/images/2020/2021/plantel2023/19-_Arce_Carlos-BRAZOS-ATRAS.jpg', 3,1), 
('Rodrigo ','Herrera', CONVERT(DATE, '07/04/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'MED','https://www.barracascentral.com/images/2020/2021/plantel2023/5-_Herrera_Rodrigo-BRAZOS-ATRAS.jpg', 3,1), 
('Facundo ','Mater', CONVERT(DATE, '23/07/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'MED','https://www.barracascentral.com/images/2020/2021/plantel2023/33-_Mater_Facundo-BRAZOS-ATRAS.jpg', 3,1), 
('Iván ','Tapia', CONVERT(DATE, '23/11/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'MED','https://www.barracascentral.com/images/2020/2021/plantel2023/10-_Tapia_Ivn-BRAZOS-ATRAS.jpg', 2,1), 
('Brian ','Calderara', CONVERT(DATE, '10/01/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'MED','https://www.barracascentral.com/images/2020/2021/plantel2023/21-_Calderara_Brian_-_BRAZOS-ATRAS.jpg', 3,1), 
('Bruno ','Sepúlveda', CONVERT(DATE, '17/09/1992', 103), 'ARG',(select ID from Equipos where Nombre like '%Barracas%'),'DEL','https://www.barracascentral.com/images/2020/2021/plantel2023/29-_Seplveda_Bruno-BRAZOS-ATRAS.jpg', 3, 1), 
...
('Ibrahim','Hesar', CONVERT(DATE, '15/11/1993', 103), 'ARG',(select ID from Equipos where Nombre like '%Belgrano%'),'MED','http://belgrano.sandboxmap.com/wp-content/uploads/1993/11/IBRAHIM-HESAR-1-375x500.jpg', 3,1), 
('Santiago','Longo', CONVERT(DATE, '12/04/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Belgrano%'),'MED','http://belgrano.sandboxmap.com/wp-content/uploads/1998/01/SANTIAGO-LONGO-375x500.jpg', 3,1), 
('Ariel','Rojas', CONVERT(DATE, '16/01/1986', 103), 'ARG',(select ID from Equipos where Nombre like '%Belgrano%'),'MED','http://belgrano.sandboxmap.com/wp-content/uploads/2022/04/ARIEL-ROJAS-375x500.jpg', 3,1), 
('Fabián','Bordagaray', CONVERT(DATE, '15/02/1987', 103), 'ARG',(select ID from Equipos where Nombre like '%Belgrano%'),'DEL','http://belgrano.sandboxmap.com/wp-content/uploads/1987/02/FABIAN-BORDAGARAY-375x500.jpg', 3,1), 
('Pablo','Vegetti', CONVERT(DATE, '15/10/1988', 103), 'ARG',(select ID from Equipos where Nombre like '%Belgrano%'),'DEL','http://belgrano.sandboxmap.com/wp-content/uploads/2018/11/PABLO-VEGETTI-375x500.jpg', 2, 1), 

--Boca

('Sergio','Romero', CONVERT(DATE, '22/02/1987', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'ARQ','https://www.bocajuniors.com.ar/upload/images/thumbs/im/ag/349x283imagen3_e492e.jpg', 1, 1), 
('Luis','Advíncula', CONVERT(DATE, '02/03/1990', 103), 'PER',(select ID from Equipos where Nombre like '%Boca%'),'DEF','https://www.bocajuniors.com.ar/upload/files/advincula_a165f.jpg', 1, 1), 
('Bruno','Valdez', CONVERT(DATE, '06/10/1992', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'DEF','https://www.bocajuniors.com.ar/upload/files/valdez-bruno1_f1ad7.jpg', 3, 1), 
('Nicolás','Figal', CONVERT(DATE, '03/04/1994', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'DEF','https://www.bocajuniors.com.ar/upload/files/figal_5e7ca.jpg', 3, 1), 
('Frank','Fabra', CONVERT(DATE, '22/02/1991', 103), 'COL',(select ID from Equipos where Nombre like '%Boca%'),'DEF','https://www.bocajuniors.com.ar/upload/files/fabra_ab7d6.jpg', 3, 1), 
('Esteban','Rolon', CONVERT(DATE, '25/03/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'MED','https://www.bocajuniors.com.ar/upload/files/rolon_235f5.jpg', 3, 1), 
('Alan','Varela', CONVERT(DATE, '04/07/2001', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'MED','https://www.bocajuniors.com.ar/upload/files/varela_e1065.jpg', 2, 1), 
('Guillermo','Fernández', CONVERT(DATE, '11/10/1991', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'MED','https://www.bocajuniors.com.ar/upload/files/pol_225ef.jpg', 2, 1), 
('Cristian','Medina', CONVERT(DATE, '01/06/2002', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'MED','https://www.bocajuniors.com.ar/upload/files/medina_548bd.jpg', 3, 1), 
('Valentín','Barco', CONVERT(DATE, '23/07/2004', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'MED','https://www.bocajuniors.com.ar/upload/files/barco_9a156.jpg', 2, 1), 
('Darío','Benedetto', CONVERT(DATE, '17/05/1990', 103), 'ARG',(select ID from Equipos where Nombre like '%Boca%'),'DEL','https://www.bocajuniors.com.ar/upload/files/benedetto_84f59.jpg', 2, 1), 

--Central Cordoba

('Matías','Mansilla', CONVERT(DATE, '15/02/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'ARQ','https://pbs.twimg.com/media/FlCFFxEXwAAg9Ty.jpg', 3, 1), 
('Ciro','Rius', CONVERT(DATE, '27/10/1988', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'DEF','https://imageup.me/images/c0a717b0-ba06-471a-8700-f04b71d72b74.png?v=151808', 3, 1), 
('Brian','Blasi', CONVERT(DATE, '08/02/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'DEF','https://imageup.me/images/4940c9ee-5f0b-4f33-8281-5e3fb16aad90.png', 3, 1), 
('Fabio','Pereyra', CONVERT(DATE, '31/01/1990', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'DEF','https://img.a.transfermarkt.technology/portrait/header/610248-1615918446.jpg?lm=1', 3, 1), 
('Gonzalo','Goñi', CONVERT(DATE, '16/08/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'DEF','https://img.a.transfermarkt.technology/portrait/header/594104-1633628040.JPG?lm=1', 3, 1), 
('José','Gómez', CONVERT(DATE, '06/03/2000', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'DEF','https://imageup.me/images/8fc0e09f-b52e-4b3c-88a8-4034e2ceeeec.png', 3, 1), 
('Brian','Farioli', CONVERT(DATE, '19/02/1998', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'MED','https://imagecache.365scores.com/image/upload/f_png,w_80,h_80,c_limit,q_auto:eco,dpr_2,d_Athletes:default.png,r_max,c_thumb,g_face,z_0.65/Athletes/71948', 3, 1), 
('Mauro','Pittón', CONVERT(DATE, '08/08/1994', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'MED','https://oneftbl-cms.imgix.net/https%3A%2F%2Fwww.rincondefutbol.com%2Fwp-content%2Fuploads%2F2023%2F04%2FMauro-Pitton-Central-Cordoba-1000x600-1.png?auto=format%2Ccompress&crop=faces&dpr=2&fit=crop&h=210&q=25&w=280&s=914f0404f543d73388af7b96d798f5b6', 3, 1), 
('Alejandro','Maciel', CONVERT(DATE, '22/04/1997', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'MED','https://ultimajugada.com/wp-content/uploads/2020/08/Maciel.jpg', 3,1), 
('Lucas','Besozzi', CONVERT(DATE, '22/01/2003', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'MED','https://lc.cx/5Xs-DN',3, 1), 
('Lucas','Gamba', CONVERT(DATE, '24/06/1987', 103), 'ARG',(select ID from Equipos where Nombre like '%Central Córdoba%'),'DEL','https://i0.wp.com/diariosanrafael.com.ar/wp-content/uploads/2023/03/IMG_3426.jpg?w=400&ssl=1', 2, 1), 

--Colón

('Ignacio','Chicco', CONVERT(DATE, '30/06/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'ARQ','https://www.radiogol.com.ar/wp-content/uploads/2022/07/FXbdG6WWAAEtoMX.jpg', 3, 1), 
('Facundo','Garcés', CONVERT(DATE, '05/09/1999', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'DEF','https://pbs.twimg.com/profile_images/1423430887979556870/JSMhKFZt_400x400.jpg', 3, 1),  
('Paolo','Goltz', CONVERT(DATE, '12/05/1985', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'DEF','https://www.ole.com.ar/images/2021/04/30/WEy9J-hJh_386x280__1.jpg', 2, 1), 
('Gian','Nardelli', CONVERT(DATE, '11/03/2000', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'DEF','https://media.tycsports.com/files/2022/10/28/498560/gian-nardelli_w416.webp', 3, 1), 
('Eric','Meza', CONVERT(DATE, '08/04/1999', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'MED','https://desdelaventana.com.ar/zixpanel/cache/med-fecha_2021-10-11_hora_10-17hs_nro-random_747.jpg', 3, 1), 
('Stéfano','Moreyra', CONVERT(DATE, '19/09/2001', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'MED','https://www.ceroacero.es/img/jogadores/55/896955_med__20220512081558_stefano_moreyra.jpg', 3, 1), 
('Cristian','Vega', CONVERT(DATE, '17/09/1993', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'MED','https://www.ole.com.ar/images/2022/03/03/HXzZzuZIr_860x575__1.jpg', 3, 1), 
('Baldomero','Perlaza', CONVERT(DATE, '05/06/1992', 103), 'COL',(select ID from Equipos where Nombre like '%Colón%'),'MED','https://www.radiogol.com.ar/wp-content/uploads/2023/02/Baldomero-Perlaza-e1675463596280.jpg', 3, 1),  
('Facundo','Farías', CONVERT(DATE, '28/08/2002', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'MED','https://media.lacapital.com.ar/p/e8556b2f03ee79c796aa9a265ad8b6a7/adjuntos/204/imagenes/030/732/0030732952/1200x675/smart/facundo-fariasjpg.jpg', 2, 1), 
('Santiago','Pierotti', CONVERT(DATE, '03/04/2001', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'DEL','https://santafedeportivo.com/wp-content/uploads/2023/04/pierotti-colon-2023-primer-plano.jpg', 3, 1),  
('Ramón','Ábila', CONVERT(DATE, '14/10/1989', 103), 'ARG',(select ID from Equipos where Nombre like '%Colón%'),'DEL','https://image-service.onefootball.com/transform?w=280&h=210&dpr=2&image=https%3A%2F%2Fsantafedeportivo.com%2Fwp-content%2Fuploads%2F2022%2F10%2Fwanchope-colon-1-1-aldosivi-2022-telefono.jpg', 2, 1), 

--Defensa y Justicia

('Luis','Unsain', CONVERT(DATE,'09/03/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'ARQ','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Usain_Ezequiel_cuaerpo_entero-768x907.png', 2, 1), 
('Agustín','Sant’ Anna',CONVERT(DATE,'27/09/1997', 103), 'URY',(select ID from Equipos where Nombre like '%Defensa y%'),'DEF','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Sant_Anna_Agustin_cuerpo_entero-768x907.png', 3, 1), 
('Nazareno','Colombo',CONVERT(DATE,'20/03/1999', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'DEF','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Colombo_Nazareno_cuerpo_entero-768x886.png', 3, 1), 
('Tomás','Cardona',CONVERT(DATE,'10/10/1995', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'DEF','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Cardona_Tomas_cuerpo_entero-768x886.png', 3, 1), 
('Alexis','Soto',CONVERT(DATE,'20/10/1993', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'DEF','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Soto_Alexis_cuerpo_entero-768x907.png', 3, 1), 
('Nicolás','Tripichio',CONVERT(DATE,'05/01/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'MED','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Tripichio_Nicolas_cuerpo_entero-768x907.png', 3, 1), 
('Kevin','Gutierrez',CONVERT(DATE,'03/06/1997', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'MED','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Gutierrez_Kevin_cuerpo_entero-768x907.png', 3, 1), 
('Rodrigo','Bogarín',CONVERT(DATE,'24/05/1997', 103), 'PRY',(select ID from Equipos where Nombre like '%Defensa y%'),'MED','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Bogarin_Rodrigo_cuerpo_entero-768x886.png', 3, 1), 
('Gabriel','Alanís',CONVERT(DATE,'16/03/1994', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'DEL','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Gabriel_Alanis_cuerpo_entero-768x886.png', 2, 1), 
('Nicolás','Fernandez',CONVERT(DATE,'08/02/1996', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'DEL','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Fernandez_Nicolas_cuerpo_entero-768x886.png', 2, 1), 
('Gastón','Togni',CONVERT(DATE,'20/09/1997', 103), 'ARG',(select ID from Equipos where Nombre like '%Defensa y%'),'DEL','http://defensayjusticia.org.ar/wp-content/uploads/2023/03/Togni_Gaston_cuerpo_entero-768x907.png', 3, 1) 

--Estudiantes
INSERT INTO Jugadores (Nombres, Apellidos, FechaDeNacimiento, Nacionalidad, Equipo, Posicion, Imagen, Tipo, Activo)
VALUES ('Mariano', 'Andújar',CONVERT(DATE,'30/07/1983',103) ,'ARG', (SELECT ID FROM Equipos WHERE Nombre LIKE '%Estudiantes%'), 'ARQ',
'https://estudiantesdelaplata.com/wp-content/uploads/2018/10/Andujar-2.jpg', 1,1),
('Santiago','Núñez',CONVERT(DATE,'29/04/2000',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'DEF',
'https://i.goalzz.com/?i=o%2Fp%2F171%2F581%2Fsantiago-misael-nune-1.jpg',3,1),
('Eros','Mancuso',CONVERT(DATE, '17/04/1999', 103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'DEF',
'https://estudiantesdelaplata.com/wp-content/uploads/2022/07/Mancuso-1.jpg',3,1),
('Luciano','Lollo',CONVERT(DATE, '29/03/1987', 103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'DEF',
'https://estudiantesdelaplata.com/wp-content/uploads/2022/06/Lollo-1.jpg',2,1),
('Zaid','Romero',CONVERT(DATE, '15/12/1999', 103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'DEF',
'https://estudiantesdelaplata.com/wp-content/uploads/2023/01/Romero.jpg',3,1),
('Emanuel','Más',CONVERT(DATE, '15/01/1989', 103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'DEF',
'https://estudiantesdelaplata.com/wp-content/uploads/2022/01/Mas-1.jpg',2,1),
('Santiago','Ascacibar',CONVERT(DATE, '25/02/1997', 103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'MED',
'https://estudiantesdelaplata.com/wp-content/uploads/2023/01/Ascacibar.jpg',3,1),
('Jorge','Rodríguez',CONVERT(DATE, '15/09/1995', 103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'MED',
'https://estudiantesdelaplata.com/wp-content/uploads/2021/02/Rodriguez.jpg',3,1),
('Fernando','Zuqui',CONVERT(DATE, '27/11/1991', 103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'MED',
'https://estudiantesdelaplata.com/wp-content/uploads/2021/06/Zuqui.jpg',3,1),
('Mauro','Méndez',CONVERT(DATE, '17/01/1997', 103),'URY',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'DEL',
'https://estudiantesdelaplata.com/wp-content/uploads/2022/07/mendez.jpg',3,1),
('Guido','Carrillo',CONVERT(DATE, '25/05/1991', 103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Estudiantes%'),'DEL',
'https://estudiantesdelaplata.com/wp-content/uploads/2023/01/Carrillo-1.jpg',2,1)


--Gimnasia
INSERT INTO Jugadores (Nombres, Apellidos, FechaDeNacimiento, Nacionalidad, Equipo, Posicion, Imagen, Tipo, Activo)
VALUES ('Tomás','Durso',CONVERT(DATE,'26/02/1999',103),'ARG', (SELECT ID FROM Equipos WHERE Nombre LIKE '%Gimnasia%'), 'ARQ',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/01/galeria-13-2_290x400_acf_cropped-1.jpg', 3,1),
('Bautista','Barros Schelotto',CONVERT(DATE,'13/01/2000',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'DEF',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-164-1_290x400_acf_cropped.jpg',3,1),
('Leonardo','Morales',CONVERT(DATE,'11/04/1991',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'DEF',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-61-1_290x400_acf_cropped.jpg',3,1),
('Felipe','Sánchez',CONVERT(DATE,'07/04/2004',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'DEF',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-267_290x400_acf_cropped.jpg',3,1),
('Nicolás','Colazo',CONVERT(DATE,'08/07/1990',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'DEF',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-129-1_290x400_acf_cropped-1.jpg', 2, 1),
('Ignacio','Miramon',CONVERT(DATE,'12/06/2003',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'MED',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-31-1_290x400_acf_cropped.jpg',3,1),
('Antonio','Napolitano',CONVERT(DATE,'16/02/1999',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'MED',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-21-2_290x400_acf_cropped.jpg',3,1),
('Franco','Soldano',CONVERT(DATE,'14/09/1994',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'MED',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-145-1_290x400_acf_cropped.jpg',2,1),
('Alan','Lescano',CONVERT(DATE,'11/11/2001',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'MED',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-233-1_290x400_acf_cropped.jpg',3,1),
('Benjamín','Domínguez',CONVERT(DATE,'19/09/2003',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'MED',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-197-1_290x400_acf_cropped.jpg',3,1),
('Cristian','Tarragona',CONVERT(DATE,'09/04/1991',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Gimnasia%'),'DEL',
'http://www.gimnasia.org.ar/wp-content/uploads/2023/02/galeria-190-1_290x400_acf_cropped.jpg',3,1)

--Godoy Cruz

INSERT INTO Jugadores (Nombres, Apellidos, FechaDeNacimiento, Nacionalidad, Equipo, Posicion, Imagen, Tipo, Activo)
VALUES ('Diego','Rodríguez',CONVERT(DATE,'25/06/1989',103),'ARG', (SELECT ID FROM Equipos WHERE Nombre LIKE '%Godoy%'), 'ARQ',
'https://pbs.twimg.com/media/FzeuICKXoAIdWIj.jpg',2,1),
('Lucas','Arce',CONVERT(DATE,'14/08/1997',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'DEF',
'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsuRp0LjXnnJdUvdrEfp97w6gBnnAJ5hruYDEqJvzJ9-cjqRtwGlgp143hB3UjMz0aNoQ&usqp=CAU',3,1),
('Pier','Barrios',CONVERT(DATE,'01/07/1990',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'DEF',
'https://pbs.twimg.com/media/FUWZ7FgXsAA-swe.jpg:large',3,1),
('Federico','Rasmussen',CONVERT(DATE,'04/03/1992',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'DEF',
'https://imagecache.365scores.com/image/upload/f_png,w_250,h_250,c_limit,q_auto:eco,d_Athletes:default.png,r_max,c_thumb,g_face,z_0.65/Athletes/8232',3,1),
('Thomas','Galdames',CONVERT(DATE,'20/11/1998',103),'CHL',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'DEF',
'https://imagecache.365scores.com/image/upload/f_png,w_250,h_250,c_limit,q_auto:eco,d_Athletes:default.png,r_max,c_thumb,g_face,z_0.65/Athletes/59708',3,1),
('Juan','Andrada',CONVERT(DATE,'04/01/1995',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'MED','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2k7pIH3Z4M1NO7ItIH2L1XVpskQI9bFhvPDh_i4Dyy1JkORR9f-SRoZGRNcRdLL0hE2g&usqp=CAU',3,1),
('Gonzalo','Abrego',CONVERT(DATE,'06/01/2000',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'MED','http://clubgodoycruz.com.ar/wp-content/uploads/2000/01/ABREGO-32-219x300.png',3,1),
('Roberto','Fernández',CONVERT(DATE,'02/03/1998',103),'URY',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'MED','https://www.soccerpunter.com/player/260893/Roberto-Nicolas-Fernandez-Fagundez',3,1),
('Hernán','López',CONVERT(DATE,'07/09/2000',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'MED','https://www.ole.com.ar/2023/07/04/X4KGfnhHe_720x0__1.jpg',3,1),
('Tadeo','Allende',CONVERT(DATE,'20/02/1999',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'MED','http://clubgodoycruz.com.ar/wp-content/uploads/1999/09/17-Tadeo-Allende-270x370.png',3,1),
('Salomón','Rodríguez',CONVERT(DATE,'16/02/2000',103),'URY',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Godoy%'),'DEL','http://clubgodoycruz.com.ar/wp-content/uploads/1998/06/20-Salom%C3%B3n-Rodr%C3%ADguez-270x370.png',3,1)
...
INSERT INTO Jugadores (Nombres, Apellidos, FechaDeNacimiento, Nacionalidad, Equipo, Posicion, Imagen, Tipo, Activo)
VALUES 
('Lucas','Chaves',CONVERT(DATE,'09/08/1995',103),'ARG', (SELECT ID FROM Equipos WHERE Nombre LIKE '%Hurac%'), 'ARQ',
'https://cahuracan.com/_next/image?url=https%3A%2F%2Fadmin2.cahuracan.com%2Fnew%2Fwp-content%2Fuploads%2F2022%2F09%2F1.-chavez-cahuracan.png-1.png&w=1920&q=75',2,1),
('Guillermo','Soto',CONVERT(DATE,'19/01/1994',103),'CHL',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'DEF',
'https://admin2.cahuracan.com/new/wp-content/uploads/2022/09/12.-soto-cahuracan-.png.png',3,1),
('Fernando','Tobio',CONVERT(DATE,'18/10/1989',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'DEF','https://admin2.cahuracan.com/new/wp-content/uploads/2022/04/2.-tobio-cahuracan-.png-1.png',2,1),
('Joaquín','Novillo',CONVERT(DATE,'19/02/1998',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'DEF','https://admin2.cahuracan.com/new/wp-content/uploads/2023/04/28.-novillo-cahuracan-.png.png',3,1),
('César','Ibañez',CONVERT(DATE,'17/06/1999',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'DEF','https://admin2.cahuracan.com/new/wp-content/uploads/2022/04/25.-ibanez-cahuracan-.png.png',3,1),
('Santiago','Hezze',CONVERT(DATE,'22/10/2001',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'MED','https://admin2.cahuracan.com/new/wp-content/uploads/2022/04/5.-hezze-cahuracan-.png.png',2,1),
('Fernando','Godoy',CONVERT(DATE,'01/05/1990',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'MED','https://admin2.cahuracan.com/new/wp-content/uploads/2022/09/11.-godoy-cahuracan-.png.png',3,1),
('Federico','Fattori',CONVERT(DATE,'22/07/1992',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'MED','https://admin2.cahuracan.com/new/wp-content/uploads/2022/04/24.-fattori-cahuracan-.png.png',3,1),
('Guillermo','Benítez',CONVERT(DATE,'08/12/1993',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'MED','https://admin2.cahuracan.com/new/wp-content/uploads/2022/09/14.-benitez-cahuracan-.png.png',3,1),
('Matías','Cóccaro',CONVERT(DATE,'15/11/1997',103),'URY',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'DEL','https://admin2.cahuracan.com/new/wp-content/uploads/2022/04/7.coccaro-cahuracan-.png.png',3,1),
('Juan','Gauto',CONVERT(DATE,'02/06/2004',103),'ARG',(SELECT ID FROM Equipos WHERE Nombre LIKE'%Hurac%'),'DEL','https://admin2.cahuracan.com/new/wp-content/uploads/2022/04/33.-gauto-cahuracan-.png.png',3,1)
...
('Luciano', 'Aued', CONVERT(DATE, '01/03/1987', 103), 'ARG', (SELECT ID FROM Equipos WHERE Nombre LIKE '%Unión%'), 'MED', 'https://cdn.sofifa.net/players/206/152/22_360.png',2,1 ),
